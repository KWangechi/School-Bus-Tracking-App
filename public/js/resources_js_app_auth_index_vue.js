"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_app_auth_index_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {// if(this.token !== null){
    //     this.getToken();
  ...
  methods: {
    getToken: function getToken() {
      ...
      axios.get("/api/user").then(function (response) {})["catch"](function (errors) {
        console.log(errors);
      });
    }
  },
    ...
    return _c(
      ...
      [
        _c("a", { attrs: { href: "/home", target: "_blank" } }, [
          _c("img", { attrs: { src: "/images/bus-logo.jpg" } }),
        ]),
        _c("br"),
        _vm._v(" "),
        ...
        _vm._v(" "),
        _c("h1", [_vm._v("This is the landing page for the application")]),
      ]
    )
  },
]
